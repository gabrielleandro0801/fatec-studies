...
def recebe_mensagem(porta2):
    ...
    if mensagem_recebida[0] == 'b':
        print(f'Mensagem recebida: {mensagem_recebida[2:]}')
    else:
        print('O computador B nao e o destino!')
        porta_tx = input('Informe a porta para o tx do computador B: ')
...
if __name__ == '__main__':
    ...
    if opcao == 't':
        ...
        destino = input('Insira o computador a ser enviado [A | C | D]: ').lower()
